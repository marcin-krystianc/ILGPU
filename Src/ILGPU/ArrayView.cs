...
namespace ILGPU
{
        ...
        where T : unmanaged
    {
        ...
        /// </summary>
        public static readonly ArrayView<T> Empty = default;
        ...
        public readonly unsafe ref T this[long index]
        {
            ...
            get
            {
                ...
                EnsureCPUBuffer();
                ref var ptr = ref Buffer.LoadEffectiveAddress(Index + index);
        ...
        internal unsafe ref byte LoadEffectiveAddress() =>
            ref Buffer.LoadEffectiveAddress(Index);
        ...
        internal unsafe IntPtr LoadEffectiveAddressAsPtr() =>
            new IntPtr(Unsafe.AsPointer(ref LoadEffectiveAddress()));
