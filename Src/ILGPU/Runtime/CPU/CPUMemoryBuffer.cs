...
namespace ILGPU.Runtime.CPU
{
    ...
    public abstract partial class CPUMemoryBuffer : MemoryBuffer
    {
        ...
        protected internal CPUMemoryBuffer(long length, int elementSize)
            ...
            long length)
        {
            ...
            CPUMemSet(
                new IntPtr(targetView.LoadEffectiveAddress()),
                value,
                0L,
                targetView.LengthInBytes);
        }
    ...
    partial class CPUMemoryBuffer
    {
        ...
        sealed class UnmanagedMemoryBuffer : PointerSourceBuffer
        {
            ...
            /// <param name="elementSize">The element size.</param>
            internal UnmanagedMemoryBuffer(long sizeInBytes, int elementSize)
                : base(
                      Marshal.AllocHGlobal(new IntPtr(sizeInBytes)),
        ...
        sealed class CudaPinnedMemoryBuffer : PointerSourceBuffer
        {
            ...
            /// <param name="sizeInBytes">The size of this buffer in bytes.</param>
            /// <param name="elementSize">The element size.</param>
            internal CudaPinnedMemoryBuffer(long sizeInBytes, int elementSize)
                : base(
                      AllocPinned(sizeInBytes),
                      sizeInBytes / elementSize,
                      elementSize)
            { }
        ...
        public static unsafe CPUMemoryBuffer Create(
            long sizeInBytes,
            int elementSize) =>
            new UnmanagedMemoryBuffer(sizeInBytes, elementSize);
        ...
        public static unsafe CPUMemoryBuffer CreateCudaPinned(
            long sizeInBytes,
            int elementSize) =>
            new CudaPinnedMemoryBuffer(sizeInBytes, elementSize);
            ...
            int elementSize)
        {
            ...
            return accelerator.AcceleratorType == AcceleratorType.Cuda
                ? CreateCudaPinned(sizeInBytes, elementSize)
                : Create(sizeInBytes, elementSize);
        }
