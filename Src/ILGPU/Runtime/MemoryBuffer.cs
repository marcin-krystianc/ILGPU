...
namespace ILGPU.Runtime
{
    ...
    public abstract class MemoryBuffer : AcceleratorObject
    {
        ...
        /// <summary>
        /// Loads the effective address for the given index.
        /// </summary>
        /// <param name="index">The element index.</param>
        /// <returns>The computed pointer.</returns>
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        protected internal unsafe ref byte LoadEffectiveAddress(long index) =>
        ...
        [CLSCompliant(false)]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        protected internal unsafe IntPtr LoadEffectiveAddressAsPtr(long index) =>
