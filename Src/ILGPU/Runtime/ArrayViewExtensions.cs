...
namespace ILGPU.Runtime
{
    ...
    public static partial class ArrayViewExtensions
    {
        ...
        public static void CopyFromCPUSync<T, TView>(
            ...
            where T : unmanaged
        {
            target.CopyFromCPUAsync(ref cpuData, length, stream);
            stream.Synchronize();
        }
        ...
        /// <remarks>This method is not supported on accelerators.</remarks>
        public static unsafe MemoryBuffer<ArrayView1D<T, Stride1D.Dense>> Allocate1D<T>(
            ...
            where T : unmanaged
        {
            ...
            if (data.Length < 1)
            {
                return new MemoryBuffer<ArrayView1D<T, Stride1D.Dense>>(
                    accelerator,
    ...
    partial struct ArrayView1D<T, TStride>
    {
        ...
        {
            long size = stride.ComputeBufferLength(extent.Size);
    ...
    partial struct ArrayView2D<T, TStride>
    {
        ...
        public readonly ArrayView3D<T, TOtherStride> As3DView<TOtherStride>(
            ...
            where TOtherStride : struct, IStride3D
        {
            long bufferLength = stride.ComputeBufferLength(extent.Size);
            var baseView = BaseView.SubView(0, bufferLength);
            return new ArrayView3D<T, TOtherStride>(
                baseView,
                extent,
